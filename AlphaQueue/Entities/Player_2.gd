...
var bullet_2 = preload("res://Entities/Bullet_2.tscn")
#End game preload
var endgame = preload("res://UI/Final.tscn")
...
func bomb():
	print("button right");
	var bullet_instance = bullet_2.instance()
	var bullet_instance2 = bullet_2.instance()
	bullet_instance.initialize(get_global_position(), rotation_degrees+120)
	bullet_instance2.initialize(get_global_position(), rotation_degrees+240)
	get_parent().add_child(bullet_instance)
